 ...
 *
 * v2: Photo displayed as a small avatar beside the name (top-left).
 *     If no photo, layout falls back to the original wide header.
 */
...
export default function MinimalistTemplate({ data }) {
  const {
    fullName, professionalTitle, email, phone, location, website,
  ...
  return (
    <div className="a4-page font-body p-12 text-[11px] text-gray-700 leading-relaxed">
      ...
      <header className="flex items-end justify-between mb-8 gap-4">
        ...
        {/* Right: contact */}
        <div className="text-right flex flex-col gap-1 text-[10px] text-gray-400 shrink-0">
