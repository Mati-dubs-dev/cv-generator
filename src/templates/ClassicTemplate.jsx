 ...
 * Great for executive, finance, legal, and academic roles
 */
  ...
  return (
    <div className="a4-page font-body p-10 text-[11px] text-gray-700 leading-relaxed">
      ...
      <header className="text-center mb-2">
        ...
        {professionalTitle && (
          <p className="text-[13px] text-gray-500 font-500 tracking-wide mb-2">{professionalTitle}</p>
        )}
        {/* Contact line */}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1">
              {skills.map((s) => (
                <span
                  key={s}
                  className="px-2 py-0.5 border border-gray-300 rounded text-[9.5px] text-gray-600"
                >
                  {s}
                </span>
              ))}
